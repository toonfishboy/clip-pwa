    ...
    return (
        <div className={"flex flex-col"}>
           <Header title={"Behälter Leckage"}/>
            <div>
                <span>Liefermenge des Kompressors [m³/min]:</span>
            ...
            <RadioGroup selected={selected}
                ...
                <LabelWrapper label={"Zulässige Motorschaltspiele/h [1/h]:"}>
                    <RadioButton value={"engineTolerance"}/>
                    <NumberInput number={getCalcValue("engineTolerance")}
                                 onChangeNumber={updateContainerValues("engineTolerance")}/>
                </LabelWrapper>
                <LabelWrapper label={"Volumen des Druckluftbehälters [l]:"}>
                    <RadioButton value={"volume"}/>
                    <NumberInput number={getCalcValue("volume")}
                                 onChangeNumber={updateContainerValues("volume")}/>
                </LabelWrapper>
            </RadioGroup>
            <div>
