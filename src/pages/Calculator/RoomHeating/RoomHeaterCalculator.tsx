...
const getEmail = (
	...
	Wärmeleistung eff. mit Wärmetauscher [kw]: ${roomHeaterResult?.heatPowerEfficiencyWithHeatTransfer} \n
	...
	Wärmeleistung eff. ${isOil ? 'Öl' : 'Gase'}heizung [kwh/Jahr]:  ${energyPriceResult?.heatPowerEfficiency} \n
